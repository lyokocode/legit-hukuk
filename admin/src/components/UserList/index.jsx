...
export const UserList = ({ user, reFetch }) => {
    ...
    const deleteUser = async () => {
        try {
            await axios.delete(`${import.meta.env.VITE_REACT_BASE_URL}/api/users/user?slug=${user.slug}`);
            reFetch()
        } catch (error) {
            serError(true)
        ...
        <tbody className="body" >
            <tr >
                ...
                <td className=" left">
                    <div>
                        <div>
                            {
                                user?.avatar ? (
                                    <img src={`${import.meta.env.VITE_REACT_SUPABASE_STORAGE}/object/public/legitstore/user/avatar/${user?.avatar}`} alt="" className="image" />
                ...
                <td className=" center actions ">
                    <div >
                        <Link to={`/users/${user?.slug}`} className="iconContainer">
